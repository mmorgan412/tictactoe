...
var checkWinner = function checkWinner() {
  ...
  if (cells[0] !== 'undefined' && cells[0] === cells[1] && cells[0] === cells[2] && cells[0] === 'x') {
    ...
    winner = 'player_o';
    ui.oWinningMessage();
  } else if (cells[0] !== undefined && cells[1] !== undefined && cells[2] !== undefined && cells[3] !== undefined && cells[4] !== undefined && cells[5] !== undefined && cells[6] !== undefined && cells[7] !== undefined && cells[8] !== undefined) {
    winner = 'draw';
    ui.drawMessage();
  }
};

var addSelector = function addSelector(event) {
...
var onUpdateGame = function onUpdateGame(event) {
  ...
  authApi.updateGame(data).catch(ui.updateGameFail);
};
...
var changePlayer = function changePlayer() {
  var currentPlayer = $('#gameBoard').attr('data-player');
  if (currentPlayer === 'x') {
    return 'o';
  } else {
    return 'x';
...
var xWinningMessage = function xWinningMessage() {
  $('#user-message').text('X Won The Game! Select New Game to play again!');
};

var oWinningMessage = function oWinningMessage() {
  $('#user-message').text('O Won The Game! Select New Game to play again!');
};

var xTurnMessage = function xTurnMessage() {
  $('#user-message').text('X\'s Turn!');
};

var oTurnMessage = function oTurnMessage() {
...
module.exports = {
  xWinningMessage: xWinningMessage,
  oWinningMessage: oWinningMessage,
  xTurnMessage: xTurnMessage,
  oTurnMessage: oTurnMessage,
...
var logOutDisplay = function logOutDisplay() {
  $('#new-game').hide();
  $('#gameBoard').hide();
  $('#sign-up').show();
  $('#sign-in').show();
